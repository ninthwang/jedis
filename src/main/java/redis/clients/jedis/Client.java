...
public class Client extends BinaryClient implements Commands {
  ...
  public void xclaim(String key, String group, String consumername, long minIdleTime, long newIdleTime, int retries,
    ...
    xclaim(key, group, consumername, minIdleTime, newIdleTime, retries, force, false, ids);
  }
  ...
  public void xclaim(String key, String group, String consumername, long minIdleTime, long newIdleTime, int retries,
    ...
    xclaim(SafeEncoder.encode(key), SafeEncoder.encode(group), SafeEncoder.encode(consumername), minIdleTime, newIdleTime, retries, force, justid, bids);
  }
