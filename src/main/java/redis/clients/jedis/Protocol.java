...
public final class Protocol {
  ...
  public static enum Command {
    ...
    , XADD, XLEN, XRANGE, XREVRANGE, XTRIM, XDEL, XINFO, XREAD, XGROUP, XPENDING, XREADGROUP, XACK, XCLAIM;
  ...
  public static enum Keyword {
    ...
    , MAXLEN, BLOCK, STREAMS, $, CREATE, SETID, DESTROY, DELCONSUMER, MKSTREAM, GROUP, GROUPS, CONSUMERS, IDLE, RETRYCOUNT, FORCE, JUSTID;
    public final byte[] raw;
